	...
	<div class = "Wrapper">
		...
		<div id = "container">
			<form action="./boardModify" method="post" enctype="multipart/form-data">
				<div id="writeArea">
					<p id="title">
						<input type="text" name="sb_title" placeholder="제목을 입력하세요." value="${modify.sb_title }">
					</p>
					<div id="wcontent">
						<div id="textC">
							<textarea name="sb_content" placeholder="내용을 입력하세요.">${modify.sb_content }</textarea>
						</div>
						<div class="bbox"> 
							...
							<button id="writeSub" type="submit" style="margin-right: 10px;" >글 수정</button>
							<input type="hidden" name="sb_no" value="${modify.sb_no }">
							<input type="hidden" name="sb_cate" value="${modify.sb_cate }">
						</div>
					</div>
				</div>
			</form>
